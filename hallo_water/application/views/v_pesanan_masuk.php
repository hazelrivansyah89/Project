                    ...
                    <table class="table">
                        ...
                        foreach ($pesanan as $key => $value) { ?>
                            <tr>
                                ...
                                <td>
                                    <b style=" text-transform: uppercase;"><?= $value->expedisi ?></b><br>
                                ...
                                <td><?php if ($value->status_bayar == '0') { ?>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <a href="<?= base_url('admin/proses/' . $value->id_transaksi) ?>" style="color: white;" class="btn btn-sm  btn-primary">Proses</a>
                                    <?php  }
                                    ?>
                            ...
                            <tr>
                                ...
                                <td><?php if ($value->status_bayar == '0') { ?>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <button style="color: white;" class="btn btn-sm  btn-primary" data-toggle="modal" data-target="#kirim<?= $value->id_transaksi ?>"><i class="fa fa-paper-plane"></i> Kirim</button>
                                    <?php  }
                                    ?>
                ...
                <div class="modal-body">
                    ...
                    <table class="table">
                        <tr>
                            <th>Expedisi</th>
                            <th>:</th>
                            <th style="text-transform: uppercase;"><?= $value->expedisi ?></th>
                        </tr>
                        <tr>
                            <th>Paket</th>
                            <th>:</th>
                            <th style="text-transform: uppercase;"><?= $value->paket ?></th>
                        </tr>
                        <tr>
                            <th>Ongkir</th>
                            <th>:</th>
                        ...
                        <tr>
                            <th>No Resi</th>
                            <th>:</th>
                            <th><input name="no_resi" class="form-control" required placeholder="No Resi"></th>
                        </tr>
                    </table>
                </div>
