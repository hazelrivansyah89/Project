                            ...
                            foreach ($belum_bayar as $key => $value) { ?>
                                <tr>
                                    ...
                                    <td><?php if ($value->status_bayar == '0') { ?>
                                            <a href="<?= base_url('pesanan_saya/bayar/' . $value->id_transaksi) ?>" style="color: white;" class="btn btn-sm btn-flat btn-primary">Bayar</a>
                                        <?php } else { ?>
                        ...
                        <table class="table">
                            ...
                            foreach ($dikirim as $key => $value) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <h5><?= $value->no_resi ?><br> <button data-toggle="modal" data-target="#diterima<?= $value->id_transaksi ?>" class="btn btn-primary btn-xs">Diterima</button></h5>
