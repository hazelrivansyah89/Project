        ...
        <div class="card-body">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <a class="btn btn-success btn-sm" href="<?= base_url('gambarbarang') ?>">back</a>
                </div>
            </div>
            <?php echo form_close() ?>
            ...
            <div class="row">
                <?php foreach ($gambar as $key => $value) { ?>
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            <img class="align-items-center" src="<?= base_url('assets/gambarbarang/' . $value->gambar) ?>" id="gambar_load" width="273px" height="230px">
                        </div>
                        <p for="" class="text-center"><?= $value->ket ?></p>
                        <button data-toggle="modal" data-target="#delete<?= $value->id_gambar ?>" class="btn btn-danger btn-xs btn-block" href="#"><i class="fa fa-trash"></i> Delete</button>
                    </div>
