            ...
            <div class="table-responsive">
                <table class="table">
                    <tr>
                        ...
                        <td style="font-weight: bold;">: Rp. <?php echo number_format($this->cart->total()); ?></td>
                    </tr>
                    <tr>
                        <th>Berat</th>
                        <td style="font-weight: bold;">: <?= $tot_berat ?> gr</td>
                    </tr>
                    <tr>
                        <th>Ongkir</th>
                        <td style="font-weight: bold;">: <label id="ongkir"></label></td>
                    </tr>
                    <tr>
                        <th>Total Bayar</th>
